...
/*   Updated: 2023/09/15 16:29:46 by jaeyojun         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void    set_render(t_game *game, t_ray *ray, t_render *render)
{
    ...
    render->side_x -= floor(render->side_x); // 왜 ?
...
void set_fnc(t_game *game)
{
    ...
    while (wid < WIN_WIDTH)
    {
        ...
        {
            game->buf[hei][wid] = 0xFFFFFF;
            //game->c_color; //ceiling
            game->buf[WIN_HEIGHT - hei - 1][wid] = 0x000000;
            //game->f_color; //floor
            hei++;
        }
        wid++;
