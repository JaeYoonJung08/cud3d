...
/*   Updated: 2023/09/15 17:45:39 by jaeyojun         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void    move_ver(int dir, t_game *game)
{
    if (dir == FRONT)
    {
        if (game->map_copy[(int)(game->player->pos_x + game->player->dir_x * MOVE_SPEED)]\
        [(int)(game->player->pos_y)] != '0')
            game->player->pos_x += game->player->dir_x * MOVE_SPEED;
        if (game->map_copy[(int)(game->player->pos_x)][(int)(game->player->pos_y + \
