...
/*   Updated: 2023/09/15 17:22:04 by jaeyojun         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->img->c_color = (game->img->ceil[0] << 16) | \
		(game->img->ceil[1] << 8) | game->img->ceil[2];
	game->img->f_color = (game->img->floor[0] << 16) | \
		(game->img->floor[1] << 8) | game->img->floor[2];
}
